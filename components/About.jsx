      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            and am currently working there. I work wiht javascript, html, and
            css, and php.
          </p>
          <p className="py-2 text-gray-600">
            ...
            marketing. I love creating and problem solving in programming, I
            love the thrill of finding a solution. I want to help others create
            websites they love, make them money, and find solutions for their
            needs. When I'm not coding, you'll find me painting, watching
