      ...
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16">
        ...
        <div>
          <ul style={{ color: `${linkColor}` }} className="hidden md:flex">
            <Link href="/">
              <li className="ml-10 text-sm border-[#5651e5] uppercase font-semibold hover:border-b">
                Home
              </li>
            </Link>
            <Link href="/#about">
            ...
            <Link href="/#contact">
              <li className="ml-10 text-sm border-[#5651e5] font-semibold uppercase hover:border-b">
                Contact
              </li>
            </Link>
          </ul>
